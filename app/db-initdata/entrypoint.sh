...
REQUIRED_VARS="DB_WRITER_HOST DB_PORT DB_NAME DB_MASTER_USERNAME DB_MASTER_PASSWORD"
...
mysql -h"$DB_WRITER_HOST" -P"$DB_PORT" -u"$DB_MASTER_USERNAME" -p"$DB_MASTER_PASSWORD" "$DB_NAME" < /app/initdata.sql
