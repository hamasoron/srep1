...
subnet_list = [
  ...
  { name = "1c", cidr_block = "10.0.36.0/24", type = "protected" },
  { name = "1d", cidr_block = "10.0.37.0/24", type = "protected" },
  { name = "1a", cidr_block = "10.0.38.0/24", type = "private" },
  { name = "1c", cidr_block = "10.0.39.0/24", type = "private" },
