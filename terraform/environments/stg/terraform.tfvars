...
environment_name                  = "stg"            ########## [変更可能](例: prod, stg, dev)
create_protected_ngw_associations = false             ########## [変更可能](例: true, false)
vpc_cidr                          = "10.0.32.0/19"   ########## [変更可能](例: 10.0.0.0/19, 10.0.32.0/19, 10.0.64.0/19)
subnet_list = [                                      ########## [変更可能](vpc_cidrの変更によって変更が必要)
  ...
  { name = "1a", cidr_block = "10.0.34.0/24", type = "protected" },
  { name = "1c", cidr_block = "10.0.35.0/24", type = "protected" },
  { name = "1a", cidr_block = "10.0.36.0/24", type = "private" },
  { name = "1c", cidr_block = "10.0.37.0/24", type = "private" },
]
