...
nat_gateway_list = [
  { az = "1a", enabled = true },  ### prod環境：2AZ時は2個、3AZ時は2個（コスト重視）または3個（高可用性）が推奨
  { az = "1c", enabled = true },
  { az = "1d", enabled = true },
]
subnet_list = [
  { name = "1a", cidr_block = "10.0.0.0/24", type = "public" }, ### create_protected_ngw_associationsとnat_gateway_listに合わせて設定
...
deployment_mode                        = "writer_with_2_readers"
